...
3.类型：list成分判断题
4.方法及方法分析：
time complexity order:  optimization SET method O(N) < two pointer method O(N2)
space complexity order: optimization SET method O(1) = two pointer method O(1)
5.edge case: 
    input:
...
'''
idea： brute force - two pointer method
Method：
